...
<head>
    ...
    <link rel="stylesheet" href="css/page-userRegister.css" type="text/css">
        ...
        <form action="userRegister.do" class="form">
            ...
            <div class="form-body">
                ...
                <div class="ui-input narrow-input">
                    ...
                    <img style="float: right;margin-right: 30px;;width: 80px;height: 30px" id="checkCode" src="checkCode.do">
                </div>
